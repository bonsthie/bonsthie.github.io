...
- [My projects (just below)](#Main%20Work)
- [Write-ups](write%20ups.md)

[my github](https://github.com/bonsthie/)
...
### FRAG (current)
Automatically analyzes documents to detect the correct folder, organizes files instantly, enables users to ask questions directly on documents, and allows files to be forwarded into a colleague’s _panier_ for handling, all through a simple interface and seamless plugins for tools like **Konica Minolta** and **Outlook**.